...
const Product = ({ prd }) => {
  ...
  return (
    <div className="xl:w-1/5 lg:w-1/4 md:w-1/3 sm:w-1/2 max-sm:w-full h-[480px] border-2 bg-gray-600 hover:border-indigo-600 duration-700 m-2 p-1 space-y-1 shadow-md shadow-gray-300 rounded-md ">
      <div
